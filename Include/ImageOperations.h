...
namespace K9 {
	namespace Images {
		...
		public:
			...
			::K9::Image resample(::K9::Image &imageIn, float newWidth, float newHeight, const ::K9::Filter &filter)const;
			::K9::Image resample(::K9::Image &imageIn, float xl, float xh, float yl, float yh, float newWidth, float newHeight, const ::K9::Filter &filter)const;
		private:
			::K9::Image resampleRows(::K9::Image &imageIn, float xl, float xh, float yl, float yh, float newWidth, float newHeight, const ::K9::Filter &filter)const;
			::K9::Image resampleColumns(::K9::Image &imageIn, float xl, float xh, float yl, float yh, float newWidth, float newHeight, const ::K9::Filter &filter)const;
